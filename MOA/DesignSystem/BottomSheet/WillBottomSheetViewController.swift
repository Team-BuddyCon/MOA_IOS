...
final class WillBottomSheetViewController: BaseViewController {
    ...
    var delegate: WillBottomSheetDelegate?
...
private extension WillBottomSheetViewController {
    func setupLayout() {
...
extension WillBottomSheetViewController: UIGestureRecognizerDelegate {
...
// MARK: objective-C
extension WillBottomSheetViewController {
